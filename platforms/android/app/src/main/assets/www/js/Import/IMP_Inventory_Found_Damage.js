...
function EnableFoundCargo() {
    ...
    if (document.getElementById('rdoFoundCargo').checked) {
        ...
        // if(localStorage.getItem("isMasterPresent")=="0"){
        //     errmsg = "Please enter Master details</br>"+localStorage.getItem("isMasterPresent");
        //     $.alert(errmsg);
        // return;
        // }
        $('#divNormalCargo').show();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $(xmlDoc).find('Table1').each(function (index) {
                    ...
                    $('#txtGroupID').val($(this).find('GroupID').text());
